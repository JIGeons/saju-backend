 ...
 * 대운 리스트 가져오기
 */
exports.listBigFortune = (gender, yearSky, monthSky, monthGround, bigFortuneNumber) => {
  // 순행(true), 역행(false) 판단
  ...
  if ((gender === "MALE" && minusPlus === "양") || (gender === "FEMALE" && minusPlus === "음")) {
    direction = true;
  } else if ((gender === "MALE" && minusPlus === "음") || (gender === "FEMALE" && minusPlus === "양")) {
    direction = false;
  }
...
exports.listMonthFortune = function (year) {
  ...
  for (let i = 0; i < 12; i++) {
    ...
    monthFortunes.push(monthFortunes[i]);
  }
